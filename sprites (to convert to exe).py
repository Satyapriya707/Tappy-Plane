...
class Mob_up(pg.sprite.Sprite):
    def __init__(self, game, midtopx, midtopy, scale):
        ...
        pg.sprite.Sprite.__init__(self, self.groups)
        self.game = game        
        self.image = pg.image.load(path.join(game.img_dir, MOB_UP_IMG)).convert()
...
class Mob_down(pg.sprite.Sprite):
    def __init__(self, game, midbottomx, midbottomy, scale):
        ...
        pg.sprite.Sprite.__init__(self, self.groups)
        self.game = game
        self.image = pg.image.load(path.join(game.img_dir, MOB_DOWN_IMG)).convert()
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
        self.scale = scale
        self.image = pg.transform.scale(self.image, (int(self.rect.width * self.scale),
...
class Ground(pg.sprite.Sprite):
    def __init__(self, game, x):
        ...
        pg.sprite.Sprite.__init__(self, self.groups)
        self.game = game
        self.image = pg.image.load(path.join(game.img_dir, GROUND_IMG)).convert()
...
class Explosion(pg.sprite.Sprite):
    def __init__(self, game, player):
        ...
        for i in range(9):
            ...
            img = pg.image.load(path.join(game.img_dir, filename)).convert()
            img.set_colorkey(BLACK)
...
class Pow(pg.sprite.Sprite):
    def __init__(self, game):
        ...
        self.image = pg.image.load(path.join(game.img_dir, 'starGold.png')).convert()
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
